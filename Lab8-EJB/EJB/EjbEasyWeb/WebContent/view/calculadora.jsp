...
<head>
<title>Curso EJB - Calculadora</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
</head>
<body>
	<h3>Curso EJB - Calculadora</h3>
	<form action="/EjbEasyWeb/calculadoraServlet" method="post">
		<input type="text" name="valor1" value="${valor1}" size="10" /> 
		<input type="text" name="valor2" value="${valor2}" size="10" /> 
